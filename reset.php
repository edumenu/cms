    ...
    if(isset($_POST['password']) && isset($_POST['confirmPassword'])){
        ...
        if($_POST['password'] === $_POST['confirmPassword']){
            ...
            if($stmt = mysqli_prepare($connection, "UPDATE users SET token='', user_password='{$hashedPassword}' WHERE user_email = ?")){
                ...
                mysqli_stmt_execute($stmt);
                //This function returns the total number of rows changed, deleted, or instead by the last executed statement
                    ...
                    <div class="panel-body">
                        ...
                        <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-ok color-green"></i></span>
