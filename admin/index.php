    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="page-header">
                Welcome to Admin
                <small> <?php echo $_SESSION['firstname']; echo " " . $_SESSION['lastname']; ?> </small>
            </h1>
...
<div class="row">
    ...
    <!-- /.row -->
        ...
        //Retrieving posts that have a draft status
        $post_draft_count = checkStatus('posts','post_status', 'draft');
                        
        //Retreiving comments that are unapproved               
    ...
    <div class="row">
        ...
        function drawChart() {
            ...
            $element_count = [$post_count,$post_published_count, $post_draft_count, $comment_count, $unapproved_comments, $users_count, $subscriber_count,$categories_count];
...
$(document).ready(function(){
  ...
  var pusher = new Pusher('b35b81bb53e919adf2a3', {
  ...
  //Subscribing to the channel notification
